    ...
    def create_package_schema(self) -> Schema:
        ...
        schema.update({
            ...
            'funderIdType': [tk.get_validator('not_empty'),
                                 tk.get_converter('convert_to_extras')],
            'awardNumber': [tk.get_validator('not_empty'),
                                 tk.get_converter('convert_to_extras')],
            'awardURI': [tk.get_validator('not_empty'),
                                 tk.get_converter('convert_to_extras')],
            ...
            'contributorAffiliation': [tk.get_validator('ignore_missing'),
                                 tk.get_converter('convert_to_extras')],
            'collectedDate': [tk.get_validator('ignore_missing'),
                                 tk.get_converter('convert_to_extras')],
            ...
            'associatedNote': [tk.get_validator('ignore_missing'),
                                 tk.get_converter('convert_to_extras')],
            'dataLocation': [tk.get_validator('ignore_missing'),
                                 tk.get_converter('convert_to_extras')],
            'responsiblePerson': [tk.get_validator('ignore_missing'),
                                 tk.get_converter('convert_to_extras')],
    ...
    def show_package_schema(self) -> Schema:
        ...
        schema.update({
            ...
            'contributorAffiliation': [tk.get_converter('convert_from_extras'),
                                 tk.get_validator('ignore_missing')],
            'collectedDate': [tk.get_converter('convert_from_extras'),
                                 tk.get_validator('ignore_missing')],
